"""
SemEval 2026 Task 4 Subtask 1 - v10
...
3. If split → route to GPT-5.2 Chat (Azure) for final decision
"""
...
OUTPUT_PATH = "data/v10_results.csv"
...
def build_pro_prompt(row: dict, votes: list[str]) -> str:
    """Enhanced prompt for GPT-5.2 Chat on split votes."""
...
async def main():
    print(f"{'═'*60}")
    print(f"SemEval 2026 Task 4 Subtask 1 - v10")
